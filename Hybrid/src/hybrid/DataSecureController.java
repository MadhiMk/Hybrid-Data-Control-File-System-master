 ...
 * @author Mk
 */
public class DataSecureController implements Initializable {
...
private void handleProcess(ActionEvent event){
                File inputFile = new File(bf.getText());
		File encryptedFile = new File(sf.getText()+"\\"+fname.getText()+combotype.getValue());
		try {
